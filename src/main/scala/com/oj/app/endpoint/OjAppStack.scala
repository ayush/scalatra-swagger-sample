...
import org.scalatra.json.{NativeJsonSupport, JacksonJsonSupport}
import org.json4s.{Formats, DefaultFormats}
import org.scalatra.swagger.SwaggerSupport

trait SwaggerApiEndpoint extends ScalatraServlet with NativeJsonSupport with SwaggerSupport {
...
trait OjAppStack extends ScalatraServlet with ScalateSupport {
